    ...
    <aside className={`${styles.container} ${isOpen ? styles.open : ""}`}>
      ...
      <nav className={styles.navMenu}>
        ...
        <div className={styles.sectionHeader} onClick={() => toggleSection("general")}>
            ...
            <FiChevronDown className={`${styles.chevron} ${expandedSections.general ? styles.chevronOpen : ""}`} />
        </div>
        <div className={`${styles.collapsibleContent} ${expandedSections.general ? styles.expanded : ""}`}>
            <button
        ...
        {/* ─── SECCIÓN: MIS LÍNEAS ─── */}
        <div className={`${styles.sectionHeader} ${styles.headingSpacing}`} onClick={() => toggleSection("misLineas")}>
            <p className={styles.heading}>MIS LÍNEAS</p>
            <FiChevronDown className={`${styles.chevron} ${expandedSections.misLineas ? styles.chevronOpen : ""}`} />
        </div>
        <div className={`${styles.collapsibleContent} ${expandedSections.misLineas ? styles.expanded : ""}`}>
            <button
        ...
        {/* ─── SECCIÓN: TERCEROS ─── */}
        <div className={`${styles.sectionHeader} ${styles.headingSpacing}`} onClick={() => toggleSection("terceros")}>
            <p className={styles.heading}>TERCEROS</p>
            <FiChevronDown className={`${styles.chevron} ${expandedSections.terceros ? styles.chevronOpen : ""}`} />
        </div>
        <div className={`${styles.collapsibleContent} ${expandedSections.terceros ? styles.expanded : ""}`}>
            <button
        ...
        <div className={`${styles.sectionHeader} ${styles.headingSpacing}`} onClick={() => toggleSection("administracion")}>
            <p className={styles.heading}>ADMINISTRACIÓN</p>
            <FiChevronDown className={`${styles.chevron} ${expandedSections.administracion ? styles.chevronOpen : ""}`} />
        </div>
        <div className={`${styles.collapsibleContent} ${expandedSections.administracion ? styles.expanded : ""}`}>
            <button
