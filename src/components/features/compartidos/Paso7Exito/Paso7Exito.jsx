...
import { FiCheckCircle, FiDownload, FiEdit3, FiArrowLeft, FiFileText } from "react-icons/fi";
      ...
      <div className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.heroText}>
            <span className={styles.heroSubtitle}>Solicitud N°384 por $3.000.000</span>
            <h1 className={styles.heroTitle}>¡Felicitaciones!<br/>Tu solicitud está pre-aprobada</h1>
          </div>
        </div>
      </div>
        ...
        <div className={styles.stepCard}>
          ...
          <div className={styles.stepContent}>
            ...
            <p className={styles.stepText}>
              Descargá este documento, firmalo y envialo escaneado vía mail a <a href="mailto:comerciales@bindgarantias.com.ar" className={styles.textHighlight}>comerciales@bindgarantias.com.ar</a>. <br/>
              <span className={styles.textMuted}>¡Es firma simple, no hace falta certificar!</span>
            </p>
          ...
          <div className={styles.stepContent}>
            ...
            <div className={styles.mtSmall}>
              <Alert variant="default" layout="pill" icon={FiEdit3}>
                La firma se valida a través de AFIP. Necesitarán clave fiscal Nivel 2 o superior.
              </Alert>
            </div>
