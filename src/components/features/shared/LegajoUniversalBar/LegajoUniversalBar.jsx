...
export function LegajoUniversalBar({
  ...
  }, [adminMode, hayCambiosSinSincronizar, faltaMigrarEnBackend, isMigrating, isLoading, loadingSocioWeb, loadingEstadoCdaSocio, migracionBloqueadaPorLineas, context, modalesLegajoAbiertos, lastAttemptedFingerprint, fingerprint, socioIdActivo]);
