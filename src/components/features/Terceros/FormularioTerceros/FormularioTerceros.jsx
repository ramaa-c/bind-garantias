...
import { SeccionDatosTerceros } from "../SeccionDatosTerceros/SeccionDatosTerceros";
import {
  useCrearTercero,
  useActualizarTercero,
} from "../../../../hooks/useTerceros";
import styles from "./FormularioTerceros.module.css";

export const FormularioTerceros = ({
